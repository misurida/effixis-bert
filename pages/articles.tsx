...
import { Title, Text, Paper, Modal, Badge, ColorSwatch, Group, Tooltip, Button, NumberInput, Popover, Stack, Slider, ThemeIcon } from '@mantine/core'
import { useData } from '../hooks/useData'
import { useMemo, useState } from 'react';
import { Article } from '../utils/types';
import { getContrastColor } from '../components/annotations/AnnotationsEditor';
...
const Articles: NextPage = () => {
  ...
  const items = useMemo(() => filteredArticles.length > 0 ? filteredArticles : articles, [filteredArticles, articles])
  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      <Group mb="md">
        <Title order={2} mr="xl">Articles</Title>
        <Group spacing={5}>
